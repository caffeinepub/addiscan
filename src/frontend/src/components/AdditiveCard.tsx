    ...
    <div className="bg-card rounded-xl shadow-card hover:shadow-card-hover transition-shadow duration-200 border border-border overflow-hidden animate-fade-in">
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="flex items-start justify-between gap-3 mb-3">
          ...
          {/* Concern badge */}
          <span
            className={`inline-flex items-center gap-1 text-xs font-semibold px-2.5 py-1 rounded-full whitespace-nowrap flex-shrink-0 ${concernClasses}`}
          >
        ...
        {/* Category badge */}
        <span
          className={`inline-block text-xs font-medium px-2.5 py-0.5 rounded-sm mb-3 ${categoryColor}`}
        >
          {additive.category}
        </span>
