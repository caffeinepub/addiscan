...
import { AlertTriangle, CheckCircle, AlertCircle, Package, FlaskConical, Tag } from 'lucide-react';
    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span className={`inline-flex items-center gap-1.5 text-sm font-medium px-3 py-1 rounded-md ${categoryColor}`}>
      ...
      <div className={`rounded-xl p-4 ${concernClasses}`}>
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="font-semibold text-sm">{getConcernLabel(concernLevel)}</span>
        </div>
      ...
      <div>
        ...
        <p className="text-sm text-foreground leading-relaxed">{additive.description}</p>
      </div>
