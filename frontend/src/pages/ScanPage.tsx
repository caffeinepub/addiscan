...
import { Scan, Loader2, AlertCircle, ClipboardPaste, Sparkles } from 'lucide-react';

const EXAMPLE_INGREDIENTS = `Water, Sugar, Citric Acid, Sodium Benzoate (E211), Aspartame (E951), Tartrazine (E102), Natural Flavors, Xanthan Gum (E415)`;
...
export function ScanPage() {
  ...
  const handleAnalyze = async () => {
    ...
    if (!ingredientsText.trim()) {
      setValidationError('Please paste or type the ingredient list from the product label.');
      return;
    }
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-muted-foreground text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
          Paste the ingredient list from the back of any product to instantly identify preservatives, additives, and their health effects.
        </p>
      </div>
      ...
      {parseIngredients.isError && (
        <Alert variant="destructive" className="mb-6 animate-fade-in">
          ...
          <AlertDescription>
            Failed to analyze ingredients. Please check your connection and try again.
          </AlertDescription>
        </Alert>
      )}
      ...
      {results === null && !parseIngredients.isPending && (
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-4 animate-fade-in">
          {[
            ...
            <div key={step} className="bg-card rounded-xl border border-border p-4 text-center">
